...
import cassetteImg from '../../assets/cassette_img.jpg';
import personIcon from '../../assets/person_1.jpg';
...
const OurWorks = () => {
  ...
  const sectionTitleStyle = {
    fontSize: '1.2rem',
    color: '#ff0000',
    marginBottom: '5px', // Reduced space
  };
...
const mainHeadingStyle = {
  ...
  return (
    <div style={containerStyle}>
      {/* Centered Title */}
      <h1 style={titleStyle}>Our Works</h1>
      ...
      <div style={contentContainerStyle}>
        ...
        <div style={contentStyle}>
          <p style={sectionTitleStyle}>Web Design</p>
          <h2 style={mainHeadingStyle}>Cassette Tape</h2>
